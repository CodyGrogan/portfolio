   ...
   [])
    ...
    return(
      ...
      <div className='container content'>
          ...
          Hi, I'm Cody, an aspiring full stack webdeveloper. I've been programming as a hobby for over two years, and hope to make a career in web development. I have experience building the frontend and backend of webapps with JavaScript and TypeScript. I previously was pursuing a career in academia studying Chinese history in Taiwan and I am fluent in Mandarin Chinese, but I decided that I would prefer to pursue a career in the tech industry rather than in academia.
